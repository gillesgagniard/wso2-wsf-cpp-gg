	...
	*/
	...
	public:
		...
		*/
		...
		/**
		* Clean the environment related to current thread context. This method
        * is supposed to be called from the client applications to clean the environment.
		*/
        static WSF_EXTERN void WSF_CALL clean();
