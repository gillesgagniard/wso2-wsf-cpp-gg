...
ntlm_exe:
	...
	$(CC) $(CFLAGS) $(INCLUDE_PATH) $(CLIENT_SAMPLES_HOME_DIR)\ntlm\ntlm_post.cpp /Foint.msvc\ntlm\ /c
	$(LD) $(LDFLAGS) int.msvc\ntlm\*.obj $(LIBS) /OUT:$(WSFCPP_SAMPLES_DIR)\ntlm.exe
	if exist $(WSFCPP_SAMPLES_DIR)\ntlm.exe.manifest $(MT) -nologo -manifest $(WSFCPP_SAMPLES_DIR)\ntlm.exe.manifest -outputresource:$(WSFCPP_SAMPLES_DIR)\ntlm.exe;1
...
wsfcpp_samples: int_dir distdir echo_samples flickr_exe ntlm_exe google_exe math_exe notify_exe yahoo_exe mtom_exe echo_service mtom_service version_service notify_service math_service
